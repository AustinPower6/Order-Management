...
CREATE TABLE IF NOT EXISTS firma (
    ...
    buchungsexport_format TEXT DEFAULT 'json',
    datev_berater_nr TEXT DEFAULT '',
    datev_mandanten_nr TEXT DEFAULT '',
    ...
    ki_openrouter_reason_aktiv  INTEGER DEFAULT 0,
    ki_openrouter_reason_an     INTEGER DEFAULT 1,
    ki_openrouter_budget_aktiv  INTEGER DEFAULT 0,
    ki_openrouter_budget        INTEGER DEFAULT 1000,
    ki_anthropic_reason_aktiv   INTEGER DEFAULT 0,
    ki_anthropic_reason_an      INTEGER DEFAULT 1,
    ki_anthropic_budget_aktiv   INTEGER DEFAULT 0,
    ki_anthropic_budget         INTEGER DEFAULT 1000,
    ki_anthropic_effort_uebersetzung      TEXT DEFAULT '',
    ki_anthropic_effort_rueckuebersetzung TEXT DEFAULT '',
    ki_anthropic_effort_bewertung         TEXT DEFAULT '',
    ki_lokal_reason_aktiv       INTEGER DEFAULT 0,
    ki_lokal_reason_an          INTEGER DEFAULT 1,
    ki_lokal_budget_aktiv       INTEGER DEFAULT 0,
    ki_lokal_budget             INTEGER DEFAULT 1000,
    ...
    ki_rueck_openrouter_reason_aktiv INTEGER DEFAULT 0,
    ki_rueck_openrouter_reason_an    INTEGER DEFAULT 1,
    ki_rueck_openrouter_budget_aktiv INTEGER DEFAULT 0,
    ki_rueck_openrouter_budget       INTEGER DEFAULT 1000,
    ki_rueck_anthropic_reason_aktiv  INTEGER DEFAULT 0,
    ki_rueck_anthropic_reason_an     INTEGER DEFAULT 1,
    ki_rueck_anthropic_budget_aktiv  INTEGER DEFAULT 0,
    ki_rueck_anthropic_budget        INTEGER DEFAULT 1000,
    ki_rueck_lokal_reason_aktiv      INTEGER DEFAULT 0,
    ki_rueck_lokal_reason_an         INTEGER DEFAULT 1,
    ki_rueck_lokal_budget_aktiv      INTEGER DEFAULT 0,
    ki_rueck_lokal_budget            INTEGER DEFAULT 1000,
    ...
    ki_llm_uebersetzung      INTEGER DEFAULT 1,
    ki_llm_rueckuebersetzung INTEGER DEFAULT 2,
    ki_llm_bewertung         INTEGER DEFAULT 1,
    ki_llm_neuuebersetzung   INTEGER DEFAULT 1,
    ki_llm_rechtschreibung   INTEGER DEFAULT 1,
...
CREATE TABLE IF NOT EXISTS firma_ki_lokal (
    ...
    reason_aktiv INTEGER DEFAULT 0,
    reason_an    INTEGER DEFAULT 1,
