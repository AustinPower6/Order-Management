...
- [ ] (2026-06-29) App-Sprachen-Generator: Lauf in 3 Phasen + abbruchsichere Zwischenspeicherung
  ...
  - Doku: Abschnitt „Zusätzliche App-Sprachen erstellen" (id `app-sprachen`) ergänzen: Der Lauf läuft jetzt in drei Phasen — (1) Übersetzen, (2) Rückübersetzen, (3) sinngemäße Prüfung mit gezielter Neuübersetzung der schlechten Treffer; Phase 3 wird bei jedem Lauf automatisch ausgeführt (nicht mehr nur bei „Nur fehlende"). Der Zwischenstand wird **laufend (nach jedem Batch bzw. jeder geprüften Zeile) gespeichert** — bricht der Lauf ab (Abbrechen, Fehler, Absturz), bleiben die bereits übersetzten Zeilen erhalten und stehen beim nächsten Öffnen sofort zur Verfügung.
